...
// Ejecutar en consola allegro-config --libs
// #include "allegro.h"
#include "GoM.h"
...
/*! \fn main ()
 *  \brief Función principal del software.
 *
 *  Crea a un objeto \c Juego, y le da el control mediante la llamada
 *  a la función función principal de \c GoM, \c LanzarGoM().
 */
