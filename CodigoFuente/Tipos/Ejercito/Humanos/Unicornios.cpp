...
/*! \file Unicornios.cpp
 *  \brief Fichero que implementa a la clase \c Unicornios.
 *
...
const Atrib Unicornios::a = { "Unicornios", 150, 6, 0, 5, 4, 2, 1, 8, 9, 2, 8,
													0, 0, Punto(10, 20), 45 };

// Unicornios::Unicornios
/*************************************/
Unicornios::Unicornios (string dir, Humanos *h, double fw, double fh)
	: Unidad(Unicornios::a, dir, (Ejercito*)h, 5, 20, fw, fh, "Unicornios")
{}

// Unicornios::UnidadVirtual
/*************************************/
Unidad* Unicornios::UnidadVirtual()
{
	Unicornios *l = new Unicornios(*this);
