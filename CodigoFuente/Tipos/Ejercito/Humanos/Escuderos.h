...
/*! \file Escuderos.h
 *  \brief Fichero que define a la clase \c Escuderos.
 *
 ...
 *  \since 1
 */
#ifndef _GoM_ESCUDEROS_
#define _GoM_ESCUDEROS_

#include <string>
#include "../Unidad.h"

/*! \class Escuderos
 *  \brief Clase escuderos.
 *
 *  \author Aarón Bueno Villares, <abv150ci@gmail.com>
 *  \date 04/2010
 *  \version 1
 *  \since 1
 */
class Escuderos : public Unidad
{
 public:
  Unidad* UnidadVirtual ();

  /* Constructor */
  Escuderos (std::string dir, Humanos *h, double fw, double fh);
