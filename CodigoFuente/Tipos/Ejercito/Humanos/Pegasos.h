...
/*! \file Pegasos.h
 *  \brief Fichero que define a la clase \c Pegasos.
 *
 ...
 *  \since 1
 */
#ifndef _GoM_PEGASOS_
#define _GoM_PEGASOS_
 ...
 *  \since 1
 */
class Pegasos : public Unidad
{
 public:
  Unidad* UnidadVirtual ();

  /* Constructor */
  Pegasos (std::string dir, Humanos *h, double fw, double fh);
