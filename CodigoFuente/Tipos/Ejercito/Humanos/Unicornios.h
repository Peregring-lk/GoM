...
/*! \file Unicornios.h
 *  \brief Fichero que define a la clase \c Unicornios.
 *
 ...
 *  \since 1
 */
#ifndef _GoM_UNICORNIOS_
#define _GoM_UNICORNIOS_

#include <string>
#include "../Unidad.h"

/*! \class Unicornios
 *  \brief Clase unicornios.
 *
 *  \author Aarón Bueno Villares, <abv150ci@gmail.com>
 *  \date 04/2010
 *  \version 1
 *  \since 1
 */
class Unicornios : public Unidad
{
 public:
  Unidad* UnidadVirtual ();

  /* Constructor */
  Unicornios (std::string dir, Humanos *h, double fw, double fh);
