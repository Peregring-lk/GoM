...
/*! \file Legion.cpp
 *  \brief Fichero que implementa a la clase \c Legion.
 *
...
const Atrib Legion::a = { "Legión", 50, 5, 0, 4, 4, 2, 1, 5, 7, 1, 7,
													0, 0, Punto(10, 10), 25 };

// Legion::Legion
/*************************************/
Legion::Legion (string dir, Humanos *h, double fw, double fh)
	: Unidad(Legion::a, dir, (Ejercito*)h, 10, 40, fw, fh, "Legión")
{}

// Legion::UnidadVirtual
/*************************************/
Unidad* Legion::UnidadVirtual()
{
	Legion *l = new Legion(*this);
