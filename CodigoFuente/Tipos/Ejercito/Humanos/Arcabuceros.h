...
/*! \file Arcabuceros.h
 *  \brief Fichero que define a la clase \c Arcabuceros.
 *
 ...
 *  \since 1
 */
#ifndef _GoM_ARCABUCEROS_
#define _GoM_ARCABUCEROS_

#include <string>
#include "../Unidad.h"

/*! \class Arcabuceros
 *  \brief Clase arcabuceros.
 *
 *  \author Aarón Bueno Villares, <abv150ci@gmail.com>
 *  \date 04/2010
 *  \version 1
 *  \since 1
 */
class Arcabuceros : public Unidad
{
 public:
  Unidad* UnidadVirtual ();

  /* Constructor */
  Arcabuceros (std::string dir, Humanos *h, double fw, double fh);
