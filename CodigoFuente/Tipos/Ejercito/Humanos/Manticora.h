...
/*! \file Manticora.h
 *  \brief Fichero que define a la clase \c Mantícora.
 *
 ...
 *  \since 1
 */
#ifndef _GoM_MANTICORA_
#define _GoM_MANTICORA_

#include <string>
#include "../Unidad.h"

/*! \class Manticora
 *  \brief Clase mantícora.
 *
 *  \author Aarón Bueno Villares, <abv150ci@gmail.com>
 *  \date 04/2010
 *  \version 1
 *  \since 1
 */
class Manticora : public Unidad
{
 public:
  Unidad* UnidadVirtual ();

  /* Constructor */
  Manticora (std::string dir, Humanos *h, double fw, double fh);
