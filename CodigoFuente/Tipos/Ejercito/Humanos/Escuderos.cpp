...
/*! \file Escuderos.cpp
 *  \brief Fichero que implementa a la clase \c Escuderos.
 *
...
const Atrib Escuderos::a = { "Escuderos", 125, 4, 5, 4, 3, 2, 1, 4, 7, 2, 4,
													4, 100, Punto(10, 20), 40 };

// Escuderos::Escuderos
/*************************************/
Escuderos::Escuderos (string dir, Humanos *h, double fw, double fh)
	: Unidad(Escuderos::a, dir, (Ejercito*)h, 5, 20, fw, fh, "Escuderos")
{}

// Escuderos::UnidadVirtual
/*************************************/
Unidad* Escuderos::UnidadVirtual()
{
	Escuderos *l = new Escuderos(*this);
