...
/*! \file Equites.h
 *  \brief Fichero que define a la clase \c Equites.
 *
 ...
 *  \since 1
 */
#ifndef _GoM_EQUITES_
#define _GoM_EQUITES_
 ...
 *  \since 1
 */
class Equites : public Unidad
{
 public:
  Unidad* UnidadVirtual ();

  /* Constructor */
  Equites (std::string dir, Humanos *h, double fw, double fh);
