...
const Atrib Guerreros::a = { "Guerreros", 50, 3, 0, 4, 4, 1, 1, 2, 6, 1, 2,
														 0, 0, Punto(10, 10), 10 };

// Guerreros::Guerreros
/*************************************/
Guerreros::Guerreros (string dir, Orcos *h, double fw, double fh)
	: Unidad (Guerreros::a, dir, (Ejercito*)h, 20, 60, fw, fh, "Guerreros")
{}

// Guerreros::UnidadVirtual
/*************************************/
Unidad* Guerreros::UnidadVirtual ()
{
	Guerreros *l = new Guerreros(*this);
