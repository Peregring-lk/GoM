...
#ifndef _GoM_EDIFICIO_
#define _GoM_EDIFICIO_

#include <string>
#include "../Unidad.h"

class Edificio : public Unidad
{
 public:
  Unidad* UnidadVirtual ();

  /* Constructor */
  Edificio(std::string dir, GAIA *g, double fw, double fh);

	void Inicializar(Punto posicion, SDL_Surface *edificio,
